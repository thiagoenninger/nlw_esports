  ...
  return (
    <div className="max-w-[1344px] mx-auto flex flex-col items-center my-20">
      ...
      <h1 className='text-6xl text-white font-black mt-20'>
        SEU <span className="bg-gradient-duo text-transparent bg-clip-text">DUO</span> ESTÁ AQUI
      </h1>

      <div className="grid grid-cols-6 gap-6 my-16">
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/game-1.png" alt="" />
          <div className='w-full pt-16 pb-4 px-4 bg-game-text-gradient absolute bottom-0 left-0 right-0'>
      ...
      <div className='pt-1 bg-gradient-duo self-stretch rounded-lg overflow-hidden mt-1'>
        <div className="bg-[#2a2634] px-6 py-6 flex justify-between items-center">
          <div>
            <strong className="text-2xl text-white font-black block mb-2">Nao encontrou seu duo?</strong>
